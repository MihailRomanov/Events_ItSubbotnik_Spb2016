...
namespace EPAM.NHModelingLanguage
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides NHModelingLanguage files
	/// The implementation is done in NHModelingLanguageDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class NHModelingLanguageDirectiveProcessor : NHModelingLanguageDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public NHModelingLanguageDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides NHModelingLanguage files
	/// </summary>
	public class NHModelingLanguageDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string NHModelingLanguageDirectiveProcessorName = "NHModelingLanguageDirectiveProcessor";
		...
		/// </summary>
		private const string providesModelParameter = "NHModel";
		...
		/// </summary>
		private const string supportedDirectiveName = "NHModelingLanguage";
		...
		/// Constructor
		/// </summary>
		public NHModelingLanguageDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return NHModelingLanguageDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::EPAM.NHModelingLanguage.NHModel));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::EPAM.NHModelingLanguage.NHModel));
					...
					if (!this.oneTimeCodeGenerated && global::System.IO.File.Exists(this.Host.TemplateFile))
					{
						...
						resolver.Name = "Convert" + "NHModel" + "RelativePathToTemplateRelativePath";
		...
		protected override void GeneratePreInitializationCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				...
				{
					string[] domainModels = {
						"EPAM.NHModelingLanguage.NHModelingLanguageDomainModel",
					};
				...
				if (languageProvider != null)
				{
					...
					if(LoadDiagramData)
					{
						...
						invokeEnableDiagramRules = new global::System.CodeDom.CodeMethodInvokeExpression(
							new global::System.CodeDom.CodeMethodReferenceExpression(new global::System.CodeDom.CodeTypeReferenceExpression("NHModelingLanguageDomainModel"), "EnableDiagramRules"), new global::System.CodeDom.CodePropertyReferenceExpression(new global::System.CodeDom.CodeThisReferenceExpression(), "Store"));
		...
		public override string[] GetImportsForProcessingRun()
		{
			...
			imports.Add("EPAM.NHModelingLanguage");
